...
class GameLogger:
    ...
    def _update_stats(self, event_type: GameEventType, kwargs: Dict[str, Any]):
        ...
        if event_type == GameEventType.TANK_SPAWN:
            ...
            try:
                team = int(kwargs.get("team"))
            except (TypeError, ValueError):
                team = 0
            if team == 1:
                self.game_stats["team1_shots_fired"] += 1
            elif team == 2:
                self.game_stats["team2_shots_fired"] += 1
            ...
            try:
                ...
                team = 0
            if team == 1:
                self.game_stats["team1_hits_landed"] += 1
            elif team == 2:
                self.game_stats["team2_hits_landed"] += 1
...
Team 1 Shots Fired: {self.game_stats["team1_shots_fired"]}
Team 1 Hits Landed: {self.game_stats["team1_hits_landed"]}
Team 1 Hit Accuracy: {(self.game_stats["team1_hits_landed"] / self.game_stats["team1_shots_fired"] * 100) if self.game_stats["team1_shots_fired"] > 0 else 0:.1f}%
Team 2 Shots Fired: {self.game_stats["team2_shots_fired"]}
Team 2 Hits Landed: {self.game_stats["team2_hits_landed"]}
Team 2 Hit Accuracy: {(self.game_stats["team2_hits_landed"] / self.game_stats["team2_shots_fired"] * 100) if self.game_stats["team2_shots_fired"] > 0 else 0:.1f}%
